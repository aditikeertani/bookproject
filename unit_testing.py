...
def check_equal(description: str, actual, expected) -> None:
    ...
    if actual_type != expected_type:
        ...
        # Terms replace {numbers} format specifiers
        print("{0} FAILED: expected ({1}) has type {2}, " "but actual ({3}) has type {4}".format(description, expected, str(expected_type).strip('<class> '), 
